...
São basicamente 3 ferramentas do jogo Minecraft (um remix do mod avaritia, feito por mim), que levam mais de 300 cubinhos de origami (as 3) para serem feitas!

======================================
OUTROS:
======================================

Fiz um design no canva sobre a tela de bloqueio da one ui 7 da samsung, e com animações 

Peguei um spritesheet e cortei na mao com pixel studio ≈83 sprites

Tenho um projeto que analiso os apps da One Ui 8.5 da samsung e recrio eles em páginas web! (Ele é um app...), outro app e um que é um app de bloco de notas para musicos, e outro que e um especial para a minha namorada...

Fiz uma animação de pixel art da cena de Undertale (rota neutra, quando toca o inicio do ost 080, finale, com as almas girando num fundo preto)!

Já criei meu próprio mod para minecraft P.E (CraftCulture), sendo uma releitura do mod reforged avaritia, só que ele nao existe mais porque eu perdi os arquivos originais dele...

Criei um manga: I found a princess when i saved my nation, era de um menino (eu), que vivia numa cidade magica e namorou uma menina que o pai dela abusava dela, ele tirou ela do pai dela e se casaram, so que as imagens foram no chatgpt e os dialogos no canva (≈110 paginas)

Sem contar que ja escrevi desde ≈ 3.5 anos

Escuto música desde 4 anos

Peguei um addon de minecraft e refiz trocando as texturas (addon, avaritia)!

Já usei e sei mexer com hub de pendrive!

Peguei uma musica de ≈10 minutos e cortei em ≈10 partes com editores de audio

Fiz um projeto que e basicamente pegar climax de musicas e juntar com outros climax (metade da musica mais metade da outra por exemplo...)!

Ja criei jogos no pocket code que contam minha história de vida e autobiografia

Ja usei 16 musicas para contar minha história de vida (e uma eu gravei ela de um jogo...) 

Ja criei um artigo científico e enviei pra nature, mas foi rejeitado

Ja enviei um e-mail pra seduc falando do projeto mulher amparada, mas eles nao responderam até agora...

E...

Consegui montar todo esse curriculo com apenaa 15 anos sendo autista nível 1...

E tambem, baseado nas texturas do reforged avaritia, eu dupliquei elas para cada ferramenta daquele jogo!, (claro que so tem aquelas que também tem no mod reforged avaritia!), e lembre-se, o nome dessa textura e "tools reimagined", então ele nao tem armaduras, so ferramentas! (E o escudo do jogo nao conta porque entra como algo de defesa, iguais as armaduras...)
...
A partir do dia 24/08/2026: a professora de geografia dos resumos me deu uma atividade adaptada!

[imagem10](imagem10.jpg)

ate nisso o menino é prejudicado..., porque os profissionais não regularizam as faltas dele...(dia 29.04.2026)

[imagem11](imagem11.jpg)

ate nisso o menino é prejudicado..., porque os profissionais não regularizam as faltas dele...(dia 24.08.2026)

E no dia da olisp (dia 25/08/2026), eu fiz essa prova 11:41:18 e terminei as 12:20 na pressa, uma outra menina que não sou eu falou que não fez a prova hoje por causa deles que não souberam organizar, e o coordenador que não e o eduardo, o sílvio, falou que não é problema dele
...
* E, meu sonho e que o android pegue o mulher amparada, crie um perfil tipo o perfil de trabalho, os apps ja vem com as permissões concedidas, e seria impossível de desinstalar (so a usuaria pode)
 ...
 e também, tenho uma dica;
 
 quando for lembrar de tipo, sei lá
 
 hoje tenho almoço 
 
 amanha tenho apresentação 
 
 ontem pintei um quadro
 
 para lembrar disso, use:
 
 almoço, apresentação, quadro
 
 vai por mim, usei isso várias vezes e consegui lembrar de ideias de um dia e no outro dia ainda tava lembrando!
